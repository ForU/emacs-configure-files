...
(defun my-font-set-interactive()
  ...
  (let ((font-name  (intern (completing-read
    ...
    (cond
     ...
     ((eq font-name 'default)            (set-default-font "-unknown-DejaVu Sans Mono-normal-normal-normal-*-14-*-*-*-m-0-iso10646-1"))
	 ((eq font-name 'default-small)      (set-default-font "-unknown-DejaVu Sans Mono-normal-normal-normal-*-13-*-*-*-m-0-iso10646-1"))
