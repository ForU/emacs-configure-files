...
(defun color-theme-dark ()
  ...
  (color-theme-install
   '(color-theme-dark
	 ...
	 (mode-line ((t (:foreground "gray80" :background "gray15" :box (:line-width 1 :color "gray20" :style released-button)))))
     (mode-line-inactive ((t (:foreground "gray40" :background "gray10" :weight light :box (:line-width 1 :color "gray15"))))); :style released-button)))))
     ...
     (font-lock-comment-face ((t (:foreground "#465457" :slant normal :bold t))))
     (font-lock-comment-delimiter-face ((t (:foreground "#465457" :slant normal :bold t))))
     ...
     (font-lock-string-face ((t (:weight light :slant italic :foreground "gray40"))))
