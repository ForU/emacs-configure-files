...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (font-lock-comment-face ((t (:foreground "#465457" :bold nil :slant italic))))
     (font-lock-comment-delimiter-face ((t (:foreground "#465457" :bold nil :slant italic))))
