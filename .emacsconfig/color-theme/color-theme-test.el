...
(defun term-color-for-test()
  (setq term-default-bg-color "#252525")
  (setq term-default-fg-color "#D5D5D5")
  )

(defun color-theme-test ()
  ""
  (interactive)
  (color-theme-install
   '(color-theme-test
     ...
     (default ((t (nil))))
     (font-lock-comment-face ((t (:foreground "gray30" :italic t :bold t)))) ;
     (font-lock-comment-delimiter-face ((t (:foreground "gray60" :italic t :bold t)))) ;
     ...
     (font-lock-function-name-face ((t (:foreground "#F92672" :italic t :bold t))))     (font-lock-variable-name-face ((t (:foreground "#975331" ))))
     ...
     (mode-line ((t (:background "black" :foreground "white" :bold t))))
