...
;;
;; Note: Based on the good theme for vim by Tomas Restrepo, which
...
(defun term-color-for-good()
  ...
  (setq term-default-fg-color "gray70")
  )


(defun color-theme-good ()
  "Color theme based on the Good color scheme for vim."
  (interactive)
  (color-theme-install
   '(color-theme-good
     ...
     (mode-line-buffer-id ((t (:foreground "dark blue" :bold t))))
	 (mode-line ((t (:background "grey80" :foreground "gray20" :bold t :box (:line-width -1 :color "grey50") :height 1.0))))
     ...
     (font-lock-comment-face ((t (:foreground "gray50" :bold t:slant norma))))
     (font-lock-comment-delimiter-face ((t (:foreground "#465457" :slant normal))))
     (font-lock-constant-face ((t (:foreground "#AF68B4"))))
     (font-lock-doc-face ((t (:foreground "#A2D996" :slant italic))))
     (font-lock-function-name-face ((t (:foreground "#5b9cd9" :bold t))))
     (font-lock-keyword-face ((t (:foreground "#7692BE" :bold t))))
     (font-lock-negation-char-face ((t (:weight bold))))
     (font-lock-preprocessor-face ((t (:foreground "#A6E22E"))))
     (font-lock-regexp-grouping-backslash ((t (:weight bold))))
     (font-lock-regexp-grouping-construct ((t (:weight bold))))
     (font-lock-string-face ((t (:foreground "#A2D996"))))
     (font-lock-type-face ((t (:foreground "#66D9EF"))))
     (font-lock-variable-name-face ((t (:foreground "gray70"))))
     (font-lock-warning-face ((t (:foreground "#FFFFFF" :background "#333333"))))
     (fringe ((t (:background "#313642"))))
     (highlight ((t (:foreground "red3" :background "#C4BE89"))))
     ...
     (lazy-highlight ((t (:foreground "#465457"))))
     ...
     (linum ((t: (:foreground "gray40" :background "#313642" :bold t))))
     (semantic-highlight-edits-face ((t: (:background nil))))
     (trailing-whitespace ((t (:background "green"))))
     (ecb-default-highlight-face ((t (:background nil :foreground "#86D2EB"))))
     (ecb-default-general-face ((t (:background nil :foreground "white" :slant normal :italic nil))))
     (cscope-line-face ((t (:foreground "gray70"))))
     (vline ((t (:background "red" :foreground "white"))))
     ))
  (term-color-for-good)
  )
(provide 'color-theme-good)
