...
;;
;; Note: Based on the modest theme for vim by Tomas Restrepo, which
...
(defun term-color-for-modest()
  (setq term-default-bg-color "#1B1D1E")
  (setq term-default-fg-color "#445364")
  )


(defun color-theme-modest ()
  "Color theme based on the Modest color scheme for vim."
  (interactive)
  (color-theme-install
   '(color-theme-modest
	 ...
	 (mode-line ((t (:foreground "#66D9EF" :background "#2e3436" :box nil))))
     (mode-line-buffer-id ((t (:foreground nil :weight semi-bold))))
     (mode-line-inactive ((t (:foreground "#BCBCBC" :background "#2e3436" ))))
     ...
     (font-lock-comment-face ((t (:foreground "#528b8b" :bold t :slant italic))))
     (font-lock-comment-delimiter-face ((t (:foreground "#528b8b" :bold t :slant italic))))
     ...
     (semantic-highlight-edits-face ((t: (:background "#445364"))))
     ))
  (term-color-for-modest)
  )
(provide 'color-theme-modest)
